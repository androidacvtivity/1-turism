function validate_06_011() {
    ...
    coloane.forEach(col => {
        const r11 = parseFloat(values[`CAP1_R11_${col}`]) || 0;
        const r01 = parseInt(values[`CAP1_R01_${col}`]) || 0;
        const r02 = parseInt(values[`CAP1_R02_${col}`]) || 0;
...
function validate_06_012() {
    ...
    coloane.forEach(col => {
        const r11 = parseFloat(values[`CAP1_R11_${col}`]) || 0;
        const r01 = parseInt(values[`CAP1_R01_${col}`]) || 0;
        const r03 = parseInt(values[`CAP1_R03_${col}`]) || 0;
        const r09 = parseInt(values[`CAP1_R09_${col}`]) || 0;
