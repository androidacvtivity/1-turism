...
webform.validators.turism1_23 = function (v, allowOverpass) {
   ...
   //End  Checking  telefon
    ...
    var trimestrialFromDrupal = Drupal.settings.mywebform.values.TRIM;
    var yearFromDrupal = Drupal.settings.mywebform.values.YEAR;
    ...
    if (parseFloat(trimestrialFromDrupal) === currentTrimestrial && yearFromDrupal === currentYear) {
        webform.errors.push({
            'fieldName': 'TRIM',
            'msg': Drupal.t('Wrong fiscal period!')
        });
